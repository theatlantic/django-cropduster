...
``thumbs``                    Comma-separated crop primary keys to load instead
                              ...
                              edited.
``tmp_thumbs``                Comma-separated members of ``thumbs`` whose
                              renditions use temporary filenames in this
                              editing session. File-backed entries are marked
                              temporary only when the file exists.
