...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cropduster4_standaloneimage', (
            ('image', self.gf('cropduster.models.CropDusterField')(to=orm['cropduster.Image'], max_length=100, sizes=[<cropduster.resizing.Size object at 0x10267d0d0>])),
    ...
    models = {
        ...
        'cropduster.image': {
            ...
            'thumbs': ('cropduster.thumbs.CropDusterThumbField', [], {'blank': 'True', 'related_name': "'image_set'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['cropduster.Thumb']"}),
            'width': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'cropduster.standaloneimage': {
            'Meta': {'object_name': 'StandaloneImage', 'db_table': "'cropduster4_standaloneimage'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('cropduster.models.CropDusterField', [], {'to': "orm['cropduster.Image']", 'max_length': '100', 'sizes': '[<cropduster.resizing.Size object at 0x10267d0d0>]'}),
