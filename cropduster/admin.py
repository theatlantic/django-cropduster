...
from django.contrib.contenttypes.generic \
	import GenericInlineModelAdmin, BaseGenericInlineFormSet, generic_inlineformset_factory
...
class ImageInlineFormset(BaseGenericInlineFormSet):
	sizes = None
	auto_sizes = None
	default_thumb = None
	...
	def _construct_form(self, i, **kwargs):
		...
		form = super(ImageInlineFormset, self)._construct_form(i, **kwargs)
