...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.attribution'
        db.add_column('cropduster_image', 'attribution', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Image.attribution'
        db.delete_column('cropduster_image', 'attribution')
